    ...
    if (request.method === 'POST' && requestUrl.pathname === '/puppet-sheet') {
      ...
      try {
        const generated = await env.AI.run(IMAGE_MODEL, {
          prompt: [
            'Production-quality 2D hand-drawn literary storybook character rig sheet.',
            'Create ONE consistent human character only: ' + character + '.',
            'This is an animation asset sheet, not a finished scene and not a sequence of poses.',
            'Use a completely flat, uniform chroma-blue background (#0066FF).',
            'Create an EXACT 4 by 3 grid of twelve equal cells. No labels, borders, gutters, text, or objects crossing cell boundaries.',
            'Every cell contains exactly ONE isolated anatomical part from the SAME character, with identical face, hair, clothing, proportions, colors, lighting and illustration style.',
            'All parts are front-facing or in a neutral three-quarter storybook pose and are cleanly separated from the blue background.',
            'Cell 1: head including hair and face, isolated.',
            'Cell 2: torso from shoulders to hips, isolated.',
            'Cell 3: left upper arm and shoulder, isolated.',
            'Cell 4: right upper arm and shoulder, isolated.',
            'Cell 5: left forearm from elbow to wrist, WITHOUT the hand, isolated.',
            'Cell 6: right forearm from elbow to wrist, WITHOUT the hand, isolated.',
            'Cell 7: left thigh, isolated.',
            'Cell 8: right thigh, isolated.',
            'Cell 9: left lower leg and foot, isolated.',
            'Cell 10: right lower leg and foot, isolated.',
            'Cell 11: left hand, isolated.',
